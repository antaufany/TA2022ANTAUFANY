      ...
      <Container>
        <Card className="p-4 shadow" style={{ marginTop: "20px", background: "white" }}>
          ...
          <Container className="d-flex align-content-end justify-content-end">
            <Button className="btn rounded-3 " style={{ margin: "10px 10px 10px 10px", width: "150px", height: "40px", margin: "5px 10px 10px 10px" }} onClick={() => setGetAlat("LokasiDebit")}>
              Debit
            </Button>
            <Button className="btn rounded-3 " style={{ margin: "10px 10px 10px 10px", width: "150px", height: "40px", margin: "5px 10px 10px 10px" }} onClick={() => setGetAlat("LokasiQuality")}>
              Quality
            </Button>
          </Container>
